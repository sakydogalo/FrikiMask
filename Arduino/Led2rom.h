...
class Led2rom
{
  public:
    ...
    //
    boolean add_colour_r = false;
    boolean add_colour_g = false;    
    boolean add_colour_b = false;
    ...
    char rgb_tmp = 'r';
    millisDelay colourDelay_r;
    millisDelay colourDelay_g;
    millisDelay colourDelay_b;
    //
    Led2rom();
    void init();
    //WRITE TO EEPROM
  ...
  private:
    ...
    byte display_rgb [4][8]{ //*/
		...
		/*{ 0b00000000 ,0b00000000 ,0b00000000 ,0b00000000 ,0b11100000 ,0b11000000 ,0b11000000 ,0b11100000 },
		{ 0b00000000 ,0b00000000 ,0b00000000 ,0b00000000 ,0b00011000 ,0b00111100 ,0b00111100 ,0b00011000 },
		{ 0b00000000 ,0b00000000 ,0b00000000 ,0b00000000 ,0b00000111 ,0b00000011 ,0b00000011 ,0b00000111 },*/
